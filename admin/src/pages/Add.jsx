        ...
        <form onSubmit={onSubmitHandler}>
            <div className='flex flex-col w-full items-start gap-3'>
                ...
                <div className='w-full'>
                    ...
                    <input type="text" name="" id="" placeholder='Type Here' required className='w-full max-w-[500px] px-3 py-2'
                        onChange={(e) => setName(e.target.value)}
                        value={name} />
                </div>
                <div className='w-full'>
                    <p className='mb-2'>Product Description</p>
                    <textarea name="" id="" placeholder='Write content here' required className='w-full max-w-[500px] px-3 py-2'
                ...
                <div className='flex flex-col sm:flex-row gap-3 w-full sm:gap-8'>
                    <div>
                        ...
                        <select name="
                " id="" className='w-full px-3 py-2' onChange={(e) => setCategory(e.target.value)}
                            value={category}>
                ...
                " id="" className='w-full px-3 py-2'
                    ...
                    <div>
                        ...
                        <input type="Number" name="" id="" placeholder='25' className='w-full px-3 py-2 sm:w-[120px]' onChange={(e) => setPrice(e.target.value)}
                            value={price} />
                    </div>
                </div>
            </div>
            ...
            <div>
                <p className='mb-3 mt-3'>Product Sizes</p>
